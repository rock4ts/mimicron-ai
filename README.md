...
| `backend_content` | [mimicron_content_be](https://github.com/rock4ts/mimicron_content_be) — API AI-компаньона и долгосрочная память в PostgreSQL, защищён JWT сервиса авторизации |
